...
// Mark a support session ended when the operator exits (so "active sessions" is accurate).
export const terminateSupportSessionApi = (sessionId)   => request.post('/platform/tenants/support-session/terminate', { sessionId })
