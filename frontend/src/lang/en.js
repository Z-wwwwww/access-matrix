...
export default {
  job: {
    ...
    scope: { platform: 'Platform', tenant: 'Tenant' },
    ...
    column: { name: 'Task', code: 'Code', scope: 'Scope', cron: 'Cron', status: 'Status', nextFire: 'Next run', lastResult: 'Last result', actions: 'Actions' },
