...
export default {
  error: {
    ...
    auth: {
      sessionTerminated: '工作階段已被管理員終止，請重新登入',
  ...
  platform: {
    ...
    tenant: {
      ...
      list: {
        viewTable: '表格檢視', viewCards: '卡片檢視',
        segAll: '全部',
        showing: '顯示 {shown} / {total} 個租戶',
        perPage: '{n} / 頁',
        noMatch: '沒有符合「{q}」的租戶。',
        clearFilters: '清除篩選',
        noAdmin: '尚無管理員',
      ...
      overview: {
        updated: '最後更新', refresh: '重新整理',
        allRealms: '全部租戶', uptime: '運行中', recycleBin: '回收筒', thisMonth: '本月',
        healthOk: '一切正常 · 無故障', healthIssues: '有需關注項'
      },
      dashboard: {
        total: '總租戶',
        newThisMonth: '本月新增',
      ...
      ops: {
        ...
        activation: {
          ...
          tip: {
            pending: '已發送邀請但管理員尚未啟用的租戶數',
            expired: '邀請已過期且從未啟用的租戶數',
            rate: '非內建租戶中管理員已成功登入過的比例',
            median: '從建立租戶到管理員首次登入的時長中位數'
          }
        },
        engagement: {
          ...
          tip: {
            active7d: '近7天有成功登入的租戶數',
            active30d: '近30天有成功登入的租戶數',
            dau: '近24小時活躍使用者數(去重)',
            mau: '近30天活躍使用者數(去重)',
            silent: '運作中但近30天無登入的租戶數(流失預警)'
          }
        },
        reliability: {
          ...
          tip: {
            ...
            backlogAge: '最舊未分發事件的滯留時長',
            oplogErrors: '近24小時非業務的伺服器錯誤(500)數'
          }
        },
        security: {
      ...
      tooltip: {
        ...
        resume: '恢復已停用的租戶',
        edit: '編輯租戶資訊',
        builtInLocked: '內建租戶（system）不可修改'
      },
      hardDelete: {
        title: '完全刪除租戶',
        tooltip: {
