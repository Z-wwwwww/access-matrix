...
详细使用见 [User Guide](user-guide.zh-CN.md#用户管理invite--direct-模式)。
...
- 📖 [**User Guide**](user-guide.zh-CN.md) — 学会怎么管理用户 / 角色 / 权限 / 数据范围 / 多租户
- 🛠 [**Development**](development.zh-CN.md) — 怎么加新菜单 / 权限 / 数据库迁移
- 🚀 [**Deployment**](deployment.zh-CN.md) — 怎么部到生产
