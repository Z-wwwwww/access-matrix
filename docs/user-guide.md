...
> 安装步骤见 [Getting Started](getting-started.md)。本文档假设系统已经跑起来。
...
> **TODO**：未来会加 "重发邀请" 按钮，参见 [开发路线](development.md#路线图)
...
`local` profile 种了 5 个 demo 用户 + 15 条 task 数据演示 5 种 scope。详见 [data-scope demo](data-scope-demo.md)。
