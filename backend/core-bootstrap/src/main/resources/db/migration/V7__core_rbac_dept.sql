...
INSERT INTO core_rbac_dept (id, tenant_id, parent_id, code, name, path, level, sort_order) VALUES
 ('00000000000000000000DEPT01', 'default', NULL,                         'HQ',     'Head Office',     '/00000000000000000000DEPT01', 1, 1),
 ('00000000000000000000DEPT02', 'default', '00000000000000000000DEPT01', 'TOKYO',  'Tokyo Branch',    '/00000000000000000000DEPT01/00000000000000000000DEPT02', 2, 1),
 ('00000000000000000000DEPT03', 'default', '00000000000000000000DEPT01', 'OSAKA',  'Osaka Branch',    '/00000000000000000000DEPT01/00000000000000000000DEPT03', 2, 2)
ON CONFLICT DO NOTHING;
